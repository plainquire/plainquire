using FilterExpressionCreator.Demo.Models.Configuration;
using FilterExpressionCreator.Demo.Startup;
...
namespace FilterExpressionCreator.Demo
{
    internal static class Program
    {
        private const string CONFIG_BASE_NAME = "FilterExpressionCreator.Demo.config";
