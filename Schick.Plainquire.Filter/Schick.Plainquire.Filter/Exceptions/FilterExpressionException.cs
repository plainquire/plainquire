...
namespace Schick.Plainquire.Filter.Exceptions;
...
public class FilterExpressionException : Exception
{
    ...
    /// </summary>
    public IEnumerable<FilterOperator> SupportedFilterOperators { get; set; } = Array.Empty<FilterOperator>();
    ...
    public FilterExpressionException(string message, Exception? innerException = null)
