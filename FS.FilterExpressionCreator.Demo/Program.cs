using FS.FilterExpressionCreator.Demo.Models.Configuration;
using FS.FilterExpressionCreator.Demo.Startup;
...
namespace FS.FilterExpressionCreator.Demo;

internal static class Program
{
    private const string CONFIG_BASE_NAME = "FS.FilterExpressionCreator.Demo.config";
    ...
    {
        services
            .Configure<FilterExpressionCreatorConfiguration>(context.Configuration.GetSection(FilterExpressionCreatorConfiguration.CONFIGURATION_SECTION))
            .AddSingleton(serviceProvider => serviceProvider.GetRequiredService<IOptions<FilterExpressionCreatorConfiguration>>().Value)
