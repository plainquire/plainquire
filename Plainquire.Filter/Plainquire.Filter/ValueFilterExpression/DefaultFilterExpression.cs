...
public class DefaultFilterExpression : IValueFilterExpression
{
    ...
    protected internal virtual Expression? CreateExpressionForValue<TEntity, TProperty>(Expression<Func<TEntity, TProperty>> propertySelector, FilterOperator filterOperator, string? value, FilterConfiguration configuration, IFilterInterceptor? interceptor)
    {
    ...
    protected FilterExpressionException CreateFilterExpressionCreationException<TEntity, TProperty, TValue>(string message, Expression<Func<TEntity, TProperty>> property, FilterOperator filterOperator, TValue? value)
    {
        return new FilterExpressionException(message)
        {
