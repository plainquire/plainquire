...
namespace FilterExpressionCreator.Tests.Tests.TypeFilterTests
{
    ...
    public class FilterForEnumBySyntaxTests : TestBase<TestEnum>
    {
        ...
        private static readonly FilterTestCase<TestEnum, TestEnum>[] _testCases = {
            ...
            FilterTestCase.Create<TestEnum>(2000, "ISNULL", new FilterExpressionCreationException("Filter operator 'IsNull' not allowed for property type 'FilterExpressionCreator.Tests.Models.TestEnum'")),

            FilterTestCase.Create<TestEnum>(2100, "NOTNULL", new FilterExpressionCreationException("Filter operator 'NotNull' not allowed for property type 'FilterExpressionCreator.Tests.Models.TestEnum'")),
        };
    }
}
