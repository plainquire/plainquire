...
namespace FilterExpressionCreator.Tests.Tests.TypeFilterTests
{
    ...
    public class FilterForEnumByValueTests : TestBase<TestEnum>
    {
        ...
        private static readonly object[] _testCases = {
            ...
            FilterTestCase.Create(2000, FilterOperator.IsNull, new TestEnum[] { default }, new FilterExpressionCreationException("Filter operator 'IsNull' not allowed for property type 'FilterExpressionCreator.Tests.Models.TestEnum'")),

            FilterTestCase.Create(2100, FilterOperator.NotNull, new TestEnum[] { default }, new FilterExpressionCreationException("Filter operator 'NotNull' not allowed for property type 'FilterExpressionCreator.Tests.Models.TestEnum'")),
        };
