using FilterExpressionCreator.Newtonsoft.JsonConverters;
using Newtonsoft.Json;
using System.Collections.Generic;

namespace FilterExpressionCreator.Newtonsoft.Extensions
{
    /// <summary>
    ...
    public static class JsonConverterExtensions
    {
        ...
        /// </summary>
        public static JsonConverter[] FilterExpressionsNewtonsoftConverters = {
        ...
        {
            foreach (var converter in FilterExpressionsNewtonsoftConverters)
