...
namespace FS.FilterExpressionCreator.Tests.Tests.TypeFilterTests
{
    ...
    public class FilterForDateTimeOffsetByValueTests : TestBase<DateTimeOffset>
    {
        ...
        public void FilterForDateTimeByValue_WorksAsExpected(object testCase, TestModelFilterFunc<DateTimeOffset> filterFunc)
        {
            switch (testCase)
            {
                case FilterTestCase<DateTimeOffset, DateTimeOffset> dateTimeTestCase:
                    ...
                    break;
                case FilterTestCase<Section<DateTimeOffset>, DateTimeOffset> dateTimeSpanTestCase:
        ...
        private static readonly object[] _testCases = {
            ...
            FilterTestCase.Create(1204, FilterOperator.Contains, new DateTimeOffset[] { new (2100, 01, 01, 0, 0, 0, TimeSpan.Zero) }, (DateTimeOffset _) => NONE),
            FilterTestCase.Create(1205, FilterOperator.Contains, new Section<DateTimeOffset>[] { new(new DateTimeOffset(2010, 06, 01, 0, 0, 0, TimeSpan.Zero), new DateTimeOffset(2010, 06, 15, 12, 31, 00, TimeSpan.Zero)) }, (DateTimeOffset x) => x >= new DateTimeOffset(2010, 06, 01, 0, 0, 0, TimeSpan.Zero) && x < new DateTimeOffset(2010, 06, 15, 12, 31, 01, TimeSpan.Zero)),
            ...
            FilterTestCase.Create(1304, FilterOperator.EqualCaseInsensitive, new Section<DateTimeOffset>[] { new(new DateTimeOffset(2010, 01, 01, 0, 0, 0, TimeSpan.Zero), new DateTimeOffset(2020, 01, 01, 0, 0, 0, TimeSpan.Zero)) }, (DateTimeOffset x) => x == new DateTimeOffset(2010, 01, 01, 0, 0, 0, TimeSpan.Zero)),
            ...
            FilterTestCase.Create(1404, FilterOperator.EqualCaseSensitive, new Section<DateTimeOffset>[] { new(new DateTimeOffset(2010, 01, 01, 0, 0, 0, TimeSpan.Zero), new DateTimeOffset(2020, 01, 01, 0, 0, 0, TimeSpan.Zero)) }, (DateTimeOffset x) => x == new DateTimeOffset(2010, 01, 01, 0, 0, 0, TimeSpan.Zero)),
            ...
            FilterTestCase.Create(1504, FilterOperator.NotEqual, new Section<DateTimeOffset>[] { new(new DateTimeOffset(2010, 01, 01, 0, 0, 0, TimeSpan.Zero), new DateTimeOffset(2020, 01, 01, 0, 0, 0, TimeSpan.Zero)) }, (DateTimeOffset x) => x != new DateTimeOffset(2010, 01, 01, 0, 0, 0, TimeSpan.Zero)),
            ...
            FilterTestCase.Create(1603, FilterOperator.LessThan, new Section<DateTimeOffset>[] { new(new DateTimeOffset(2010, 01, 01, 0, 0, 0, TimeSpan.Zero), new DateTimeOffset(2020, 01, 01, 0, 0, 0, TimeSpan.Zero)) }, (DateTimeOffset x) => x < new DateTimeOffset(2010, 01, 01, 0, 0, 0, TimeSpan.Zero)),
            ...
            FilterTestCase.Create(1703, FilterOperator.LessThanOrEqual, new Section<DateTimeOffset>[] { new(new DateTimeOffset(2010, 01, 01, 0, 0, 0, TimeSpan.Zero), new DateTimeOffset(2020, 01, 01, 0, 0, 0, TimeSpan.Zero)) }, (DateTimeOffset x) => x <= new DateTimeOffset(2010, 01, 01, 0, 0, 0, TimeSpan.Zero)),
            ...
            FilterTestCase.Create(1803, FilterOperator.GreaterThan, new Section<DateTimeOffset>[] { new(new DateTimeOffset(2010, 01, 01, 0, 0, 0, TimeSpan.Zero), new DateTimeOffset(2020, 01, 01, 0, 0, 0, TimeSpan.Zero)) }, (DateTimeOffset x) => x > new DateTimeOffset(2010, 01, 01, 0, 0, 0, TimeSpan.Zero)),
            ...
            FilterTestCase.Create(2000, FilterOperator.IsNull, new DateTimeOffset[] { default }, new FilterExpressionCreationException("Filter operator 'IsNull' not allowed for property type 'System.DateTimeOffset'")),

            FilterTestCase.Create(2100, FilterOperator.NotNull, new DateTimeOffset[] { default }, new FilterExpressionCreationException("Filter operator 'NotNull' not allowed for property type 'System.DateTimeOffset'")),
        };
