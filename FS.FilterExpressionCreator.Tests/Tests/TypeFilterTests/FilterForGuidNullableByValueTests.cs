...
namespace FS.FilterExpressionCreator.Tests.Tests.TypeFilterTests
{
    ...
    public class FilterForGuidNullableByValueTests : TestBase<Guid?>
    {
        ...
        private static readonly FilterTestCase<Guid?, Guid?>[] _testCases = {
            ...
            FilterTestCase.Create(1200, FilterOperator.Contains, new Guid?[] { Guid.Empty }, new FilterExpressionCreationException("Filter operator 'Contains' not allowed for property type 'System.Nullable`1[System.Guid]'")),
