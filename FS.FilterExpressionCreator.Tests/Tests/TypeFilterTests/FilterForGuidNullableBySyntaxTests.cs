...
{
    [TestClass]
    public class FilterForGuidNullableBySyntaxTests : TestBase<Guid?>
    {
        [DataTestMethod]
        [FilterTestDataSource(nameof(_testCases), nameof(TestModelFilterFunctions))]
        public void FilterForGuidNullableBySyntax_WorksAsExpected(FilterTestCase<Guid?, Guid?> testCase, TestModelFilterFunc<Guid?> filterFunc)
        ...
        private static readonly FilterTestCase<Guid?, Guid?>[] _testCases = {
            ...
            FilterTestCase.Create<Guid?>(1200, "~null", new FilterExpressionCreationException("Filter operator 'Contains' not allowed for property type 'System.Nullable`1[System.Guid]'")),
            ...
            FilterTestCase.Create<Guid?>(1600, "<", new FilterExpressionCreationException("Filter operator 'LessThan' not allowed for property type 'System.Nullable`1[System.Guid]'")),

            FilterTestCase.Create<Guid?>(1700, "<=", new FilterExpressionCreationException("Filter operator 'LessThanOrEqual' not allowed for property type 'System.Nullable`1[System.Guid]'")),

            FilterTestCase.Create<Guid?>(1800, ">", new FilterExpressionCreationException("Filter operator 'GreaterThan' not allowed for property type 'System.Nullable`1[System.Guid]'")),

            FilterTestCase.Create<Guid?>(1900, ">=", new FilterExpressionCreationException("Filter operator 'GreaterThanOrEqual' not allowed for property type 'System.Nullable`1[System.Guid]'")),

            FilterTestCase.Create<Guid?>(2000, "ISNULL", x => x == null),

            FilterTestCase.Create<Guid?>(2100, "NOTNULL", x => x != null),
        };
