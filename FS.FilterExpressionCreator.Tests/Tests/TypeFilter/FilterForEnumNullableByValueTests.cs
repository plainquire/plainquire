...
public class FilterForEnumNullableByValueTests : TestBase<TestEnum?>
{
    ...
    private static readonly object[] _testCases = {
        ...
        FilterTestCase.Create(1401, FilterOperator.Default, new int[] { -10 }, (TestEnum? _) => NONE),
        ...
        FilterTestCase.Create(1801, FilterOperator.GreaterThan, new int[] { -10 }, (TestEnum? x) => x != null),
        ...
        FilterTestCase.Create(1901, FilterOperator.GreaterThanOrEqual, new int[] { -10 }, (TestEnum? x) => x != null),
