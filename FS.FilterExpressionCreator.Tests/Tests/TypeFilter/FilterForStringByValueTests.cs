...
public class FilterForStringByValueTests : TestBase<string>
{
    ...
    [
        ...
        FilterTestCase.Create(1600, FilterOperator.LessThan, [string.Empty], new FilterExpressionCreationException("Filter operator 'LessThan' not allowed for property type 'System.String'")),

        FilterTestCase.Create(1700, FilterOperator.LessThanOrEqual, [string.Empty], new FilterExpressionCreationException("Filter operator 'LessThanOrEqual' not allowed for property type 'System.String'")),

        FilterTestCase.Create(1800, FilterOperator.GreaterThan, [string.Empty], new FilterExpressionCreationException("Filter operator 'GreaterThan' not allowed for property type 'System.String'")),

        FilterTestCase.Create(1900, FilterOperator.GreaterThanOrEqual, [string.Empty], new FilterExpressionCreationException("Filter operator 'GreaterThanOrEqual' not allowed for property type 'System.String'")),
