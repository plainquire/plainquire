...
public class FilterForDateTimeNullableBySyntaxTests : TestBase<DateTime?>
{
    [DataTestMethod]
    ...
    [
        ...
        FilterTestCase.Create<DateTime?>(1017, "2010-13-40", new FilterExpressionCreationException("Unable to parse given filter value")),
        FilterTestCase.Create<DateTime?>(1018, "2010-13-40_2020-01-01", new FilterExpressionCreationException("Unable to parse given filter value")),
        FilterTestCase.Create<DateTime?>(1019, "INVALID_june-16th", new FilterExpressionCreationException("Unable to parse given filter value")),
        FilterTestCase.Create<DateTime?>(1020, "june 1st_INVALID", new FilterExpressionCreationException("Unable to parse given filter value")),
