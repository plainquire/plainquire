...
public class FilterForGuidByValueTests : TestBase<Guid>
{
    ...
    [
        ...
        FilterTestCase.Create(1600, FilterOperator.LessThan, [Guid.Empty], new FilterExpressionCreationException("Filter operator 'LessThan' not allowed for property type 'System.Guid'")),

        FilterTestCase.Create(1700, FilterOperator.LessThanOrEqual, [Guid.Empty], new FilterExpressionCreationException("Filter operator 'LessThanOrEqual' not allowed for property type 'System.Guid'")),

        FilterTestCase.Create(1800, FilterOperator.GreaterThan, [Guid.Empty], new FilterExpressionCreationException("Filter operator 'GreaterThan' not allowed for property type 'System.Guid'")),
