...
namespace FS.FilterExpressionCreator.Tests.Tests.TypeFilter
{
    ...
    public class FilterForGuidByValueTests : TestBase<Guid>
    {
        [DataTestMethod]
        [FilterTestDataSource(nameof(_testCases), nameof(TestModelFilterFunctions))]
        public void FilterForGuidByValue_WorksAsExpected(FilterTestCase<Guid, Guid> testCase, TestModelFilterFunc<Guid> filterFunc)
        ...
        private static readonly FilterTestCase<Guid, Guid>[] _testCases = {
            ...
            FilterTestCase.Create(1600, FilterOperator.LessThan,  new Guid[] { Guid.Empty }, new FilterExpressionCreationException("Filter operator 'LessThan' not allowed for property type 'System.Guid'")),

            FilterTestCase.Create(1700, FilterOperator.LessThanOrEqual,  new Guid[] { Guid.Empty }, new FilterExpressionCreationException("Filter operator 'LessThanOrEqual' not allowed for property type 'System.Guid'")),

            FilterTestCase.Create(1800, FilterOperator.GreaterThan,  new Guid[] { Guid.Empty }, new FilterExpressionCreationException("Filter operator 'GreaterThan' not allowed for property type 'System.Guid'")),

            FilterTestCase.Create(1900, FilterOperator.GreaterThanOrEqual,  new Guid[] { Guid.Empty }, new FilterExpressionCreationException("Filter operator 'GreaterThanOrEqual' not allowed for property type 'System.Guid'")),
