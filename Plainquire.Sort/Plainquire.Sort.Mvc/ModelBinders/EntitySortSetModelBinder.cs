...
{
    private readonly Dictionary<Type, (ModelMetadata, IModelBinder)> _entitySortBinders;
    ...
    /// <autogeneratedoc />
    public EntitySortSetModelBinder(Dictionary<Type, (ModelMetadata, IModelBinder)> entitySortBinders)
