...
public class FilterForEnumBySyntaxTests : TestBase<TestEnum>
{
    ...
    [
        ...
        FilterTestCase.Create<TestEnum>(2000, "ISNULL", new FilterExpressionException("Filter operator 'IsNull' not allowed for property type 'Schick.Plainquire.Filter.Tests.Models.TestEnum'")),

        FilterTestCase.Create<TestEnum>(2100, "NOTNULL", new FilterExpressionException("Filter operator 'NotNull' not allowed for property type 'Schick.Plainquire.Filter.Tests.Models.TestEnum'"))
    ];
}