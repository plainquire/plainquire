...
public class FilterForEnumByValueTests : TestBase<TestEnum>
{
    ...
    [
        ...
        FilterTestCase.Create(1101, FilterOperator.Default, [-10], (TestEnum _) => NONE),
        ...
        FilterTestCase.Create(1201, FilterOperator.Contains, [-10], (TestEnum _) => NONE),
        ...
        FilterTestCase.Create(1301, FilterOperator.EqualCaseInsensitive, [-10], (TestEnum _) => NONE),
        ...
        FilterTestCase.Create(1401, FilterOperator.EqualCaseSensitive, [-10], (TestEnum _) => NONE),
        ...
        FilterTestCase.Create(1405, FilterOperator.EqualCaseSensitive, ["positive"], (TestEnum _) => NONE),

        FilterTestCase.Create(1500, FilterOperator.NotEqual, [TestEnum.Negative], (TestEnum x) => x != TestEnum.Negative),
        FilterTestCase.Create(1501, FilterOperator.NotEqual, [-10], (TestEnum _) => ALL),
        ...
        FilterTestCase.Create(1601, FilterOperator.LessThan, [-10], (TestEnum _) => NONE),
        ...
        FilterTestCase.Create(1701, FilterOperator.LessThanOrEqual, [-10], (TestEnum _) => NONE),
        ...
        FilterTestCase.Create(1801, FilterOperator.GreaterThan, [-10], (TestEnum _) => ALL),
        ...
        FilterTestCase.Create(1901, FilterOperator.GreaterThanOrEqual, [-10], (TestEnum _) => ALL),
        ...
        FilterTestCase.Create(2000, FilterOperator.IsNull, new TestEnum[] { default }, new FilterExpressionException("Filter operator 'IsNull' not allowed for property type 'Schick.Plainquire.Filter.Tests.Models.TestEnum'")),

        FilterTestCase.Create(2100, FilterOperator.NotNull, new TestEnum[] { default }, new FilterExpressionException("Filter operator 'NotNull' not allowed for property type 'Schick.Plainquire.Filter.Tests.Models.TestEnum'"))
    ];
