...
public class FilterForEnumNullableByValueTests : TestBase<TestEnum?>
{
    [DataTestMethod]
    [FilterTestDataSource(nameof(_testCases), nameof(TestModelFilterFunctions))]
    public void FilterForEnumNullableByValue_WorksAsExpected(object testCase, TestModelFilterFunc<TestEnum?> filterFunc)
    {
        switch (testCase)
        {
    ...
    [
        ...
        FilterTestCase.Create(1401, FilterOperator.Default, [-10], (TestEnum? _) => NONE),
