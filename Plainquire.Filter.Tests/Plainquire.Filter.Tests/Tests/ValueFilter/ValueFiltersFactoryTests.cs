...
public class ValueFiltersFactoryTests : TestContainer
{
    ...
    {
        // Act
        var valueFiltersByComma = ValueFilterFactory.Create(@"!Joe,Eve,NOTNULL,\,,\;,\|");
        var valueFiltersBySemicolon = ValueFilterFactory.Create(@"!Joe;Eve;NOTNULL;\,;\;;\|");
        var valueFiltersByPipe = ValueFilterFactory.Create(@"!Joe|Eve|NOTNULL|\,|\;|\|");
