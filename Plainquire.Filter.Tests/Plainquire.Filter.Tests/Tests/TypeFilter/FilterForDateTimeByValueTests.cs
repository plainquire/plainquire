...
[TestFixture]
public class FilterForDateTimeByValueTests : TestContainer
{
    ...
    [
        ...
        FilterTestCase.Create(2000, FilterOperator.IsNull, new DateTime[] { default }, new FilterExpressionException("Filter operator 'IsNull' not allowed for property type 'System.DateTime'")),

        FilterTestCase.Create(2100, FilterOperator.NotNull, new DateTime[] { default }, new FilterExpressionException("Filter operator 'NotNull' not allowed for property type 'System.DateTime'"))
    ];
