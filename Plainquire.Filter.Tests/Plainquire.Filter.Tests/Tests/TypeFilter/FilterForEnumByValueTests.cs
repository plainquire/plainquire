...
[TestFixture]
public class FilterForEnumByValueTests : TestContainer
{
    ...
    [
        ...
        FilterTestCase.Create(1300, FilterOperator.StartsWith, [TestEnum.Negative], (TestEnum x) => x == TestEnum.Negative),
        FilterTestCase.Create(1301, FilterOperator.StartsWith, [-10], (TestEnum _) => TestItems.NONE),
        FilterTestCase.Create(1302, FilterOperator.StartsWith, [TestEnum.Positive], (TestEnum x) => x is TestEnum.Positive or TestEnum.Positive2 or TestEnum.Positive4),
        ...
        FilterTestCase.Create(1400, FilterOperator.EndsWith, [TestEnum.Negative], (TestEnum x) => x == TestEnum.Negative),
        FilterTestCase.Create(1401, FilterOperator.EndsWith, [-10], (TestEnum _) => TestItems.NONE),
        FilterTestCase.Create(1302, FilterOperator.EndsWith, [TestEnum.Positive], (TestEnum x) => x == TestEnum.Positive),
        ...
        FilterTestCase.Create(1500, FilterOperator.EqualCaseInsensitive, [TestEnum.Negative], (TestEnum x) => x == TestEnum.Negative),
        ...
        FilterTestCase.Create(1600, FilterOperator.EqualCaseSensitive, [TestEnum.Negative], (TestEnum x) => x == TestEnum.Negative),
        ...
        FilterTestCase.Create(1700, FilterOperator.NotEqual, [TestEnum.Negative], (TestEnum x) => x != TestEnum.Negative),
        ...
        FilterTestCase.Create(1800, FilterOperator.LessThan, [TestEnum.Negative], (TestEnum x) => x < TestEnum.Negative),
        ...
        FilterTestCase.Create(1900, FilterOperator.LessThanOrEqual, [TestEnum.Negative], (TestEnum x) => x <= TestEnum.Negative),
        ...
        FilterTestCase.Create(2000, FilterOperator.GreaterThan, [TestEnum.Negative], (TestEnum x) => x > TestEnum.Negative),
        FilterTestCase.Create(2001, FilterOperator.GreaterThan, [-10], (TestEnum _) => TestItems.ALL),
        ...
        FilterTestCase.Create(2100, FilterOperator.GreaterThanOrEqual, [TestEnum.Negative], (TestEnum x) => x >= TestEnum.Negative),
        FilterTestCase.Create(2101, FilterOperator.GreaterThanOrEqual, [-10], (TestEnum _) => TestItems.ALL),
        ...
        FilterTestCase.Create(2200, FilterOperator.IsNull, new TestEnum[] { default }, new FilterExpressionException("Filter operator 'IsNull' not allowed for property type 'Plainquire.Filter.Tests.Models.TestEnum'")),

        FilterTestCase.Create(2300, FilterOperator.NotNull, new TestEnum[] { default }, new FilterExpressionException("Filter operator 'NotNull' not allowed for property type 'Plainquire.Filter.Tests.Models.TestEnum'"))
    ];
