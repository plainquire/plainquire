...
public class FilterForFloatNullableBySyntaxTests
{
    ...
    [
        ...
        FilterTestCase.Create<float?>(2003, ">-20", x => x > -20f, TestConfig.FilterCultureEnUs),
        ...
        FilterTestCase.Create<float?>(2103, ">=-20", x => x > -20f, TestConfig.FilterCultureEnUs),
        FilterTestCase.Create<float?>(2104, ">=+5.5", x => x >= +5.5f, TestConfig.FilterCultureEnUs),

        FilterTestCase.Create<float?>(2200, "ISNULL", x => x == null),

        FilterTestCase.Create<float?>(2300, "NOTNULL", x => x != null)
    ];
