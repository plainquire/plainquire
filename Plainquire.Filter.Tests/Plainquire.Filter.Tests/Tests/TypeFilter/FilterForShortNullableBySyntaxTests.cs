...
[TestFixture]
public class FilterForShortNullableBySyntaxTests : TestContainer
{
    ...
    [
        ...
        FilterTestCase.Create<short?>(1204, "+5", x => x == +5),
        ...
        FilterTestCase.Create<short?>(1402, "$0", x => x == 0),
        FilterTestCase.Create<short?>(1403, "$4", _ => TestItems.NONE),
        FilterTestCase.Create<short?>(1404, "$9", x => x is 19 or -19),
        ...
        FilterTestCase.Create<short?>(2003, ">-20", x => x >= -20),
        ...
        FilterTestCase.Create<short?>(2103, ">=-20", x => x >= -20),
        FilterTestCase.Create<short?>(2104, ">=+5", x => x >= +5),

        FilterTestCase.Create<short?>(2200, "ISNULL", x => x == null),

        FilterTestCase.Create<short?>(2300, "NOTNULL", x => x != null)
    ];
}