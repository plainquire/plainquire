...
[TestFixture]
public class FilterForEnumNullableBySyntaxTests : TestContainer
{
    ...
    [
        ...
        FilterTestCase.Create<TestEnum?>(2200, "ISNULL", x => x == null),

        FilterTestCase.Create<TestEnum?>(2300, "NOTNULL", x => x != null)
    ];
}