...
[TestFixture]
public class FilterForGuidBySyntaxTests : TestContainer
{
    ...
    [
        ...
        FilterTestCase.Create<Guid>(1800, "<", new FilterExpressionException("Filter operator 'LessThan' not allowed for property type 'System.Guid'")),

        FilterTestCase.Create<Guid>(1900, "<=", new FilterExpressionException("Filter operator 'LessThanOrEqual' not allowed for property type 'System.Guid'")),
