...
[TestFixture]
public class FilterForDateTimeOffsetBySyntaxTests : TestContainer
{
    ...
    [
        ...
        FilterTestCase.Create<DateTimeOffset>(2000, "ISNULL", new FilterExpressionException("Filter operator 'IsNull' not allowed for property type 'System.DateTimeOffset'")),

        FilterTestCase.Create<DateTimeOffset>(2100, "NOTNULL", new FilterExpressionException("Filter operator 'NotNull' not allowed for property type 'System.DateTimeOffset'"))
    ];
}