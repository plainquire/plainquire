...
public class FilterForFloatBySyntaxTests
{
    ...
    [
        ...
        FilterTestCase.Create<float>(1001, "-5\\,5,+5\\,5", x => x is -5.5f or 5.5f, TestConfig.CultureDeDe),
        FilterTestCase.Create<float>(1002, "-5,5,+5,5", _ => TestItems.NONE, TestConfig.CultureDeDe),
        ...
        FilterTestCase.Create<float>(1105, "-5.5,+5.5", x => x is -5.5f or +5.5f, TestConfig.CultureEnUs),
